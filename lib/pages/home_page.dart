...
import 'package:speed_code/data/plant_data.dart';
import 'package:speed_code/pages/details_page.dart';
import 'package:speed_code/widgets/bottom_nav.dart';
import 'package:speed_code/data/category_model.dart';
import 'package:speed_code/core/color.dart';
        ...
        actions: [
          Container(
            ...
            decoration: BoxDecoration(
              color: Colors.green,
              boxShadow: [
                BoxShadow(color: Colors.green.withOpacity(0.5),
                blurRadius: 10,
        ...
        children: [
          Padding(
            ...
            child: Row(
              children: [
                ...
                boxShadow: [
                  BoxShadow(color: Colors.green.withOpacity(0.15),
                  blurRadius: 10,
                  offset: const Offset(0, 0)
                  )
                ],
              ...
              const SizedBox(width: 10),
               Container(
                ...
                color: Colors.green,
                boxShadow: [
                  BoxShadow(color: Colors.green.withOpacity(0.9),
                  blurRadius: 10,
                  offset: const Offset(0, 0)
                  )
                ],
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  // all autdoor clors meshan uka badalay😊
                    child: Column(
          ...
          SizedBox(
            ...
            child: PageView.builder(
               ...
               //yaris ika dhik contolor le waye 
      ...
      child: Container(
         ...
         padding: const EdgeInsets.all( 8.0),
              ...
              child: Stack(
                ...
                AssetImage(plants[index].imagePath),
                ///sawirka iso wayne 
                fit: BoxFit.cover
                )
